...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding model 'OfficialLibrary'
        db.create_table('udj_officiallibrary', (
            ('id', self.gf('django.db.models.fields.AutoField')(primary_key=True)),
            ('library', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['udj.Library'])),
        ))
        db.send_create_signal('udj', ['OfficialLibrary'])

        # Adding unique constraint on 'FbUser', fields ['fb_user_id']
        db.create_unique('udj_fbuser', ['fb_user_id'])

        # Adding unique constraint on 'FbUser', fields ['user']
        db.create_unique('udj_fbuser', ['user_id'])

    def backwards(self, orm):
        # Removing unique constraint on 'FbUser', fields ['user']
        db.delete_unique('udj_fbuser', ['user_id'])

        # Removing unique constraint on 'FbUser', fields ['fb_user_id']
        db.delete_unique('udj_fbuser', ['fb_user_id'])

        # Deleting model 'OfficialLibrary'
        db.delete_table('udj_officiallibrary')
    ...
    models = {
        ...
        'udj.fbuser': {
            ...
            'fb_user_id': ('django.db.models.fields.CharField', [], {'unique': 'True', 'max_length': '200'}),
            'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
        ...
        'udj.officiallibrary': {
            'Meta': {'object_name': 'OfficialLibrary'},
            'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
            'library': ('django.db.models.fields.related.ForeignKey', [], {'to': "orm['udj.Library']"})
        },
        'udj.ownedlibrary': {
