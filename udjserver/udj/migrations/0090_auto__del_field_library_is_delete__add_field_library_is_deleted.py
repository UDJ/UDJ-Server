...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Deleting field 'Library.is_delete'
        db.delete_column('udj_library', 'is_delete')

        # Adding field 'Library.is_deleted'
        db.add_column('udj_library', 'is_deleted',
                      self.gf('django.db.models.fields.BooleanField')(default=False),
                      keep_default=False)

    def backwards(self, orm):
        # Adding field 'Library.is_delete'
        db.add_column('udj_library', 'is_delete',
                      self.gf('django.db.models.fields.BooleanField')(default=False),
                      keep_default=False)

        # Deleting field 'Library.is_deleted'
        db.delete_column('udj_library', 'is_deleted')
